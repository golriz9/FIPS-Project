...
{
	partial class KeyManagementAS_TE
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(KeyManagementAS_TE));
			...
			this.Name = "KeyManagementAS_TE";
			this.Text = "Key Management Assertions and TEs";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.KeyManagementAS_TE_FormClosing);
			this.Load += new System.EventHandler(this.KeyManagementAS_TE_Load);
