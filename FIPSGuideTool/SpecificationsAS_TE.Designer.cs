...
{
	partial class SpecificationsAS_TE
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SpecificationsAS_TE));
			...
			// dataGridView_ASTE
			// 
			this.dataGridView_ASTE.BorderStyle = System.Windows.Forms.BorderStyle.Fixed3D;
			...
			this.dataGridView_ASTE.RowHeadersWidth = 60;
			...
			this.Name = "SpecificationsAS_TE";
			this.Text = "Specifications Assertions and TEs";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.SpecificationsAS_TE_FormClosing);
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.SpecificationsAS_TE_FormClosed);
			this.Load += new System.EventHandler(this.SpecificationsAS_TE_Load);
