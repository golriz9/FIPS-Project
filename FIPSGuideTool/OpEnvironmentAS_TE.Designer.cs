...
{
	partial class OpEnvironmentAS_TE
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(OpEnvironmentAS_TE));
			...
			this.Name = "OpEnvironmentAS_TE";
			this.Text = "Operational Environment Assertions and TEs";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.OpEnvironmentAS_TE_FormClosing);
			this.Load += new System.EventHandler(this.OpEnvironmentAS_TE_Load);
