...
{
	public partial class DesignAssuranceAS_TE : Form
	{
		...
		private void DesignAssuranceAS_TE_Load(object sender, EventArgs e)
		{
			// add columns
			...
			try
			{
				...
				while (dataSearch.Read())
				{
					if ((Section[ij] == "10") && (VendorTesterAll[ij] == "AS" || (VendorTesterAll[ij] == "TE")))
					{
						if ((DesignAssuranceSecurityLevel == "Level 1") && ((RequirementAll[ij] == "9") ||
							...
							(RequirementAll[ij] == "19") || (RequirementAll[ij] == "20")))
						{
							...
							((RequirementAll[ij] == "11") || (RequirementAll[ij] == "12") ||
							(RequirementAll[ij] == "13") || (RequirementAll[ij] == "14") || (RequirementAll[ij] == "15") ||
							(RequirementAll[ij] == "16") || (RequirementAll[ij] == "17") || (RequirementAll[ij] == "18") ||
							(RequirementAll[ij] == "19") || (RequirementAll[ij] == "20")))
						{
						...
						else if ((DesignAssuranceSecurityLevel == "Level 3") && ((RequirementAll[ij] == "14") ||
							(RequirementAll[ij] == "15") || (RequirementAll[ij] == "16") ||
							(RequirementAll[ij] == "17") || (RequirementAll[ij] == "18") ||
							(RequirementAll[ij] == "19") || (RequirementAll[ij] == "20")))
						{
							VendorTester[ij1] = dataSearch.GetValue(0).ToString();
							Assessment[ij1] = dataSearch.GetValue(5).ToString();
				...
				{
					if (Section[i1] == "10" && (VendorTesterAll[i1] == "AS" || (VendorTesterAll[i1] == "TE")))
					{
						text1[ij2] = text[i1];
						ij2++;
					}
		...
		private void DesignAssuranceAS_TE_FormClosing(object sender, FormClosingEventArgs e)
		{
			int ChangeFlag = 1;
			...
			if (ChangeFlag == 1)
			{
				...
				if (result == DialogResult.Yes)
				{
					...
					{
						if (VendorTesterAll[i1] == "AS" && Section[i1] == "10")
						{
						...
						if (VendorTesterAll[i1] == "TE" && Section[i1] == "10")
						{
							string inputStr = ModAssessment[i4];
							// Check if the string contains a single quote
							if (inputStr != null)
					...
					color_DesAssur = SectionProgress();
					Properties.Settings.Default.color_DesAssur = color_DesAssur;
