...
{
	public partial class EMI_EMC_AS_TE : Form
	{
		...
		private void EMI_EMC_AS_TE_Load(object sender, EventArgs e)
		{
			// add columns
			...
			try
			{
				...
				while (dataSearch.Read())
				{
					if ((Section[ij] == "8") && (VendorTesterAll[ij] == "AS" || (VendorTesterAll[ij] == "TE")))
					{
						if ((EMI_EMCSecurityLevel == "Level 1") && ((RequirementAll[ij] == "5")))
						{
						...
						else if ((EMI_EMCSecurityLevel == "Level 2") && ((RequirementAll[ij] == "5")))
						{
							VendorTester[ij1] = dataSearch.GetValue(0).ToString();
							Assessment[ij1] = dataSearch.GetValue(5).ToString();
							Requirement[ij1] = dataSearch.GetValue(2).ToString();
						...
						else if ((EMI_EMCSecurityLevel == "Level 3") && ((RequirementAll[ij] == "4")))
						{
							VendorTester[ij1] = dataSearch.GetValue(0).ToString();
							Assessment[ij1] = dataSearch.GetValue(5).ToString();
							Requirement[ij1] = dataSearch.GetValue(2).ToString();
						...
						else if ((EMI_EMCSecurityLevel == "Level 4") && ((RequirementAll[ij] == "4")))
						{
							VendorTester[ij1] = dataSearch.GetValue(0).ToString();
							Assessment[ij1] = dataSearch.GetValue(5).ToString();
							Requirement[ij1] = dataSearch.GetValue(2).ToString();
				...
				{
					if (Section[i1] == "8" && (VendorTesterAll[i1] == "AS" || (VendorTesterAll[i1] == "TE")))
					{
						text1[ij2] = text[i1];
						ij2++;
					}
		...
		private void EMI_EMC_AS_TE_FormClosing(object sender, FormClosingEventArgs e)
		{
			int ChangeFlag = 1;
			...
			if (ChangeFlag == 1)
			{
				...
				if (result == DialogResult.Yes)
				{
					...
					{
						if (VendorTesterAll[i1] == "AS" && Section[i1] == "8")
						{
						...
						if (VendorTesterAll[i1] == "TE" && Section[i1] == "8")
						{
							string inputStr = ModAssessment[i4];
							// Check if the string contains a single quote
							if (inputStr != null)
					...
					color_EMI = SectionProgress();
					Properties.Settings.Default.color_EMI = color_EMI;
