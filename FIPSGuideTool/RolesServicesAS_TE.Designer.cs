...
{
	partial class RolesServicesAS_TE
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RolesServicesAS_TE));
			...
			this.Name = "RolesServicesAS_TE";
			this.Text = "Roles, Services & Authentication Assertions and TEs";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.RolesServicesAS_TE_FormClosing);
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.RolesServicesAS_TE_FormClosed);
			this.Load += new System.EventHandler(this.RolesServicesAS_TE_Load);
