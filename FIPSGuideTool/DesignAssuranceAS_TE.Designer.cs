...
{
	partial class DesignAssuranceAS_TE
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DesignAssuranceAS_TE));
			...
			this.Name = "DesignAssuranceAS_TE";
			this.Text = "Design Assurance Assertions and TEs";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.DesignAssuranceAS_TE_FormClosing);
			this.Load += new System.EventHandler(this.DesignAssuranceAS_TE_Load);
