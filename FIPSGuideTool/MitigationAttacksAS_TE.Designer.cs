...
{
	partial class MitigationAttacksAS_TE
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MitigationAttacksAS_TE));
			...
			this.dataGridView_ASTE.RowHeadersDefaultCellStyle = dataGridViewCellStyle3;
			...
			this.Name = "MitigationAttacksAS_TE";
			this.Text = "Mitigation of Other Attacks Assertions and TEs";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.MitigationAttacksAS_TE_FormClosing);
			this.Load += new System.EventHandler(this.MitigationAttacksAS_TE_Load);
