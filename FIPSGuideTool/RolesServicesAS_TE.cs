...
{
	public partial class RolesServicesAS_TE : Form
	{
		...
		private void RolesServicesAS_TE_Load(object sender, EventArgs e)
		{
			// add columns
			...
			try
			{
				...
				while (dataSearch.Read())
				{
					if ((Section[ij] == "3") && (VendorTesterAll[ij] == "AS" || (VendorTesterAll[ij] == "TE")))
					{
						if ((RolesServicesSecurityLevel == "Level 2") && ((RequirementAll[ij] == "19") ||
							(RequirementAll[ij] == "20") || (RequirementAll[ij] == "30") || (RequirementAll[ij] == "32")))
						{
						...
						else if ((RolesServicesSecurityLevel == "Level 1") && ((RequirementAll[ij] == "16") ||
							(RequirementAll[ij] == "17") || (RequirementAll[ij] == "18") || (RequirementAll[ij] == "19") ||
							(RequirementAll[ij] == "20") || (RequirementAll[ij] == "22") || (RequirementAll[ij] == "24") ||
							(RequirementAll[ij] == "25") || (RequirementAll[ij] == "26") || (RequirementAll[ij] == "27") ||
							(RequirementAll[ij] == "28") || (RequirementAll[ij] == "31") || (RequirementAll[ij] == "32")))
						{
							VendorTester[ij1] = dataSearch.GetValue(0).ToString();
							Assessment[ij1] = dataSearch.GetValue(5).ToString();
							Requirement[ij1] = dataSearch.GetValue(2).ToString();
						...
						else if (((RolesServicesSecurityLevel == "Level 3") || (RolesServicesSecurityLevel == "Level 4")) &&
							((RequirementAll[ij] == "17") || (RequirementAll[ij] == "18") || (RequirementAll[ij] == "30") ||
							(RequirementAll[ij] == "31")))
						{
							VendorTester[ij1] = dataSearch.GetValue(0).ToString();
							Assessment[ij1] = dataSearch.GetValue(5).ToString();
							Requirement[ij1] = dataSearch.GetValue(2).ToString();
				...
				{
					if (Section[i1] == "3" && (VendorTesterAll[i1] == "AS" || (VendorTesterAll[i1] == "TE")))
					{
						text1[ij2] = text[i1];
						ij2++;
					}
		...
		private void RolesServicesAS_TE_FormClosed(object sender, FormClosedEventArgs e)
		{}

		private void RolesServicesAS_TE_FormClosing(object sender, FormClosingEventArgs e)
		{
			int ChangeFlag = 1;
			...
			if (ChangeFlag == 1)
			{
				...
				if (result == DialogResult.Yes)
				{
					...
					{
						if (VendorTesterAll[i1] == "AS" && Section[i1] == "3")
						{
						...
						if (VendorTesterAll[i1] == "TE" && Section[i1] == "3")
						{
							string inputStr = ModAssessment[i4];
							// Check if the string contains a single quote
							if (inputStr != null)
					...
					color_Roles = SectionProgress(ij3, ij4, ij5);
					Properties.Settings.Default.color_Roles = color_Roles;
		...
		public string SectionProgress(int[] ij0, int[] ij1, int[] ij2)
		{
			string color_Roles = "True";
