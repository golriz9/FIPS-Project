...
{
	public partial class OpEnvironmentAS_TE : Form
	{
		...
		private void OpEnvironmentAS_TE_Load(object sender, EventArgs e)
		{
			// add columns
			...
			try
			{
				...
				int[] ij4 = new int[VectorLength];
				int[] ij5 = new int[VectorLength];
				int[] ij6 = new int[VectorLength];
				while (dataSearch.Read())
				{
					if ((Section[ij] == "6") && (VendorTesterAll[ij] == "AS" || (VendorTesterAll[ij] == "TE")))
					{
						if ((OpEnvironmentSecurityLevel == "Level 2") && ((RequirementAll[ij] == "4") ||
							(RequirementAll[ij] == "5")  || (RequirementAll[ij] == "6")  || (RequirementAll[ij] == "20") ||
							(RequirementAll[ij] == "21") || (RequirementAll[ij] == "22") || (RequirementAll[ij] == "23") ||
							(RequirementAll[ij] == "24") || (RequirementAll[ij] == "25") || (RequirementAll[ij] == "26") ||
							(RequirementAll[ij] == "27") ))
						{
						...
						else if ((OpEnvironmentSecurityLevel == "Level 1") && ((RequirementAll[ij] == "9") || 
							(RequirementAll[ij] == "10") || (RequirementAll[ij] == "11") || (RequirementAll[ij] == "12") ||
							(RequirementAll[ij] == "13") || (RequirementAll[ij] == "14") || (RequirementAll[ij] == "15") ||
							...
							(RequirementAll[ij] == "22") || (RequirementAll[ij] == "23") || (RequirementAll[ij] == "24") ||
							(RequirementAll[ij] == "25") || (RequirementAll[ij] == "26") || (RequirementAll[ij] == "27")))
						{
							VendorTester[ij1] = dataSearch.GetValue(0).ToString();
							Assessment[ij1] = dataSearch.GetValue(5).ToString();
							Requirement[ij1] = dataSearch.GetValue(2).ToString();
						...
						else if ((OpEnvironmentSecurityLevel == "Level 3") && ((RequirementAll[ij] == "4") ||
							(RequirementAll[ij] == "5") || (RequirementAll[ij] == "6") || (RequirementAll[ij] == "9") ||
							(RequirementAll[ij] == "10") || (RequirementAll[ij] == "26") || (RequirementAll[ij] == "27")))
						{
							VendorTester[ij1] = dataSearch.GetValue(0).ToString();
							Assessment[ij1] = dataSearch.GetValue(5).ToString();
							Requirement[ij1] = dataSearch.GetValue(2).ToString();
						...
						else if ((OpEnvironmentSecurityLevel == "Level 4") && ((RequirementAll[ij] == "4") ||
							(RequirementAll[ij] == "5") || (RequirementAll[ij] == "6") || (RequirementAll[ij] == "9") ||
							(RequirementAll[ij] == "10") || (RequirementAll[ij] == "20") || (RequirementAll[ij] == "21")))
						{
							VendorTester[ij1] = dataSearch.GetValue(0).ToString();
							Assessment[ij1] = dataSearch.GetValue(5).ToString();
							Requirement[ij1] = dataSearch.GetValue(2).ToString();
				...
				{
					if (Section[i1] == "6" && (VendorTesterAll[i1] == "AS" || (VendorTesterAll[i1] == "TE")))
					{
						text1[ij2] = text[i1];
						ij2++;
					}
		...
		private void OpEnvironmentAS_TE_FormClosing(object sender, FormClosingEventArgs e)
		{
			int ChangeFlag = 1;
			for (int rows = 0; rows < dataGridView_ASTE.Rows.Count - 1; rows++)
			{
				...
				//if (Assessment[rows] != ModAssessment[rows])
				//{
				//	ChangeFlag = 1;
				//}
			}
			...
			if (ChangeFlag == 1)
			{
				...
				if (result == DialogResult.Yes)
				{
					...
					{
						if (VendorTesterAll[i1] == "AS" && Section[i1] == "6")
						{
						...
						if (VendorTesterAll[i1] == "TE" && Section[i1] == "6")
						{
							string inputStr = ModAssessment[i4];
							// Check if the string contains a single quote
							if (inputStr != null)
					...
					color_OpEnv = SectionProgress();
					Properties.Settings.Default.color_OpEnv = color_OpEnv;
		...
		public string SectionProgress()
		{
			string color_OpEnv = "True";
