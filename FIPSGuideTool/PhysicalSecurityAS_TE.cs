...
{
	public partial class PhysicalSecurityAS_TE : Form
	{
		...
		int[] ij3 = new int[VectorLength]; int[] ij7 = new int[VectorLength];
		int[] ij4 = new int[VectorLength]; int[] ij8 = new int[VectorLength];
		int[] ij5 = new int[VectorLength]; int[] ij9 = new int[VectorLength];
		int[] ij6 = new int[VectorLength];

		// create table dynamically
		DataTable DT = new DataTable();

		public PhysicalSecurityAS_TE()
		{
			InitializeComponent();
		...
		private void PhysicalSecurityAS_TE_Load(object sender, EventArgs e)
		{
			// add columns
			...
			try
			{
				...
				while (dataSearch.Read())
				{
					if ((Section[ij] == "5") && (VendorTesterAll[ij] == "AS" || (VendorTesterAll[ij] == "TE")))
					{
						if ((PhysicalSecurityLevel == "Level 1") && ((RequirementAll[ij] == "15") ||
							(RequirementAll[ij] == "16") || (RequirementAll[ij] == "17") || (RequirementAll[ij] == "18") ||
							(RequirementAll[ij] == "19") || (RequirementAll[ij] == "20") || (RequirementAll[ij] == "21") ||
							(RequirementAll[ij] == "22") || (RequirementAll[ij] == "23") || (RequirementAll[ij] == "60") ||
							(RequirementAll[ij] == "61") || (RequirementAll[ij] == "62") || (RequirementAll[ij] == "63") ||
							(RequirementAll[ij] == "64") || (RequirementAll[ij] == "65") || (RequirementAll[ij] == "66") ||
							(RequirementAll[ij] == "67") || (RequirementAll[ij] == "68") || (RequirementAll[ij] == "69") ||
							(RequirementAll[ij] == "24") || (RequirementAll[ij] == "25") || (RequirementAll[ij] == "26") ||
							(RequirementAll[ij] == "27") || (RequirementAll[ij] == "28") || (RequirementAll[ij] == "29") ||
							(RequirementAll[ij] == "30") || (RequirementAll[ij] == "31") || (RequirementAll[ij] == "32") ||
							(RequirementAll[ij] == "35") || (RequirementAll[ij] == "36") || (RequirementAll[ij] == "37") ||
							(RequirementAll[ij] == "38") || (RequirementAll[ij] == "39") || (RequirementAll[ij] == "40") ||
							(RequirementAll[ij] == "41") || (RequirementAll[ij] == "42") || (RequirementAll[ij] == "43") ||
							(RequirementAll[ij] == "44") || (RequirementAll[ij] == "45") || (RequirementAll[ij] == "48") ||
							(RequirementAll[ij] == "49") || (RequirementAll[ij] == "50") || (RequirementAll[ij] == "51") ||
							(RequirementAll[ij] == "52") || (RequirementAll[ij] == "53") || (RequirementAll[ij] == "54") ||
							(RequirementAll[ij] == "55") || (RequirementAll[ij] == "56") || (RequirementAll[ij] == "57") ||
							(RequirementAll[ij] == "58") || (RequirementAll[ij] == "59")))
						{
						...
						else if ((PhysicalSecurityLevel == "Level 2") && ((RequirementAll[ij] == "17") ||
							(RequirementAll[ij] == "18") || (RequirementAll[ij] == "19") || (RequirementAll[ij] == "20") ||
							(RequirementAll[ij] == "21") || (RequirementAll[ij] == "11") || (RequirementAll[ij] == "22") ||
							(RequirementAll[ij] == "23") || (RequirementAll[ij] == "60") || (RequirementAll[ij] == "61") ||
							(RequirementAll[ij] == "64") || (RequirementAll[ij] == "63") || (RequirementAll[ij] == "62") ||
							(RequirementAll[ij] == "65") || (RequirementAll[ij] == "66") || (RequirementAll[ij] == "67") ||
							(RequirementAll[ij] == "68") || (RequirementAll[ij] == "69") ||
							(RequirementAll[ij] == "27") || (RequirementAll[ij] == "28") || (RequirementAll[ij] == "29") ||
							(RequirementAll[ij] == "30") || (RequirementAll[ij] == "31") || (RequirementAll[ij] == "32") ||
							(RequirementAll[ij] == "38") || (RequirementAll[ij] == "39") || (RequirementAll[ij] == "40") ||
							(RequirementAll[ij] == "41") || (RequirementAll[ij] == "42") || (RequirementAll[ij] == "43") ||
							(RequirementAll[ij] == "44") || (RequirementAll[ij] == "45") || (RequirementAll[ij] == "51") ||
							(RequirementAll[ij] == "52") || (RequirementAll[ij] == "53") || (RequirementAll[ij] == "54") ||
							(RequirementAll[ij] == "55") || (RequirementAll[ij] == "56") || (RequirementAll[ij] == "57") ||
							(RequirementAll[ij] == "58") || (RequirementAll[ij] == "59")))
						{
						...
						else if ((PhysicalSecurityLevel == "Level 3") && ((RequirementAll[ij] == "11") ||
							(RequirementAll[ij] == "22") || (RequirementAll[ij] == "23") || (RequirementAll[ij] == "69") ||
							(RequirementAll[ij] == "66") || (RequirementAll[ij] == "67") || (RequirementAll[ij] == "68") ||
							(RequirementAll[ij] == "65") || (RequirementAll[ij] == "64") || (RequirementAll[ij] == "63") ||
							(RequirementAll[ij] == "62") || (RequirementAll[ij] == "61") || (RequirementAll[ij] == "60") ||
							(RequirementAll[ij] == "30") || (RequirementAll[ij] == "31") || (RequirementAll[ij] == "32") ||
							(RequirementAll[ij] == "40") || (RequirementAll[ij] == "41") || (RequirementAll[ij] == "42") ||
							(RequirementAll[ij] == "43") || (RequirementAll[ij] == "44") || (RequirementAll[ij] == "45") ||
							(RequirementAll[ij] == "54") || (RequirementAll[ij] == "55") || (RequirementAll[ij] == "56") ||
							(RequirementAll[ij] == "57") || (RequirementAll[ij] == "58") || (RequirementAll[ij] == "59")))
						{
							VendorTester[ij1] = dataSearch.GetValue(0).ToString();
							Assessment[ij1] = dataSearch.GetValue(5).ToString();
							Requirement[ij1] = dataSearch.GetValue(2).ToString();
						...
						else if ((PhysicalSecurityLevel == "Level 4") && ((RequirementAll[ij] == "11")))
						{
							VendorTester[ij1] = dataSearch.GetValue(0).ToString();
							Assessment[ij1] = dataSearch.GetValue(5).ToString();
							Requirement[ij1] = dataSearch.GetValue(2).ToString();
						...
						else if ((Embodiment == "Multi-Chip Standalone") && ((RequirementAll[ij] == "24") ||
							(RequirementAll[ij] == "25") || (RequirementAll[ij] == "26") ||
							(RequirementAll[ij] == "27") || (RequirementAll[ij] == "28") ||
							(RequirementAll[ij] == "29") || (RequirementAll[ij] == "30") ||
							(RequirementAll[ij] == "31") || (RequirementAll[ij] == "32") ||
							(RequirementAll[ij] == "33") || (RequirementAll[ij] == "34") ||
							(RequirementAll[ij] == "35") || (RequirementAll[ij] == "36") ||
							(RequirementAll[ij] == "37") || (RequirementAll[ij] == "38") ||
							(RequirementAll[ij] == "39") || (RequirementAll[ij] == "40") ||
							(RequirementAll[ij] == "41") || (RequirementAll[ij] == "42") ||
							(RequirementAll[ij] == "43") || (RequirementAll[ij] == "44") ||
							(RequirementAll[ij] == "45")))
						{
							VendorTester[ij1] = dataSearch.GetValue(0).ToString();
							Assessment[ij1] = dataSearch.GetValue(5).ToString();
							Requirement[ij1] = dataSearch.GetValue(2).ToString();
						...
						else if ((Embodiment == "Single Chip") &&
							((RequirementAll[ij] == "51") || (RequirementAll[ij] == "52") ||
							(RequirementAll[ij] == "53") || (RequirementAll[ij] == "54") ||
							(RequirementAll[ij] == "55") || (RequirementAll[ij] == "56") ||
							(RequirementAll[ij] == "57") || (RequirementAll[ij] == "58") ||
							(RequirementAll[ij] == "59") || (RequirementAll[ij] == "48") ||
							(RequirementAll[ij] == "49") || (RequirementAll[ij] == "50") ||
							(RequirementAll[ij] == "46") || (RequirementAll[ij] == "47") ||
							(RequirementAll[ij] == "40") || (RequirementAll[ij] == "41") ||
							(RequirementAll[ij] == "42") || (RequirementAll[ij] == "43") ||
							(RequirementAll[ij] == "44") || (RequirementAll[ij] == "45") ||
							(RequirementAll[ij] == "38") || (RequirementAll[ij] == "39") ||
							(RequirementAll[ij] == "35") || (RequirementAll[ij] == "36") ||
							(RequirementAll[ij] == "37")))
						{
							VendorTester[ij1] = dataSearch.GetValue(0).ToString();
							Assessment[ij1] = dataSearch.GetValue(5).ToString();
							Requirement[ij1] = dataSearch.GetValue(2).ToString();
							...
							(RequirementAll[ij] == "49") || (RequirementAll[ij] == "50") ||
							(RequirementAll[ij] == "46") || (RequirementAll[ij] == "47") ||
							(RequirementAll[ij] == "30") || (RequirementAll[ij] == "31") ||
							(RequirementAll[ij] == "32") || (RequirementAll[ij] == "27") ||
							(RequirementAll[ij] == "28") || (RequirementAll[ij] == "29") ||
							(RequirementAll[ij] == "24") || (RequirementAll[ij] == "25") ||
							(RequirementAll[ij] == "26")))
						{
							VendorTester[ij1] = dataSearch.GetValue(0).ToString();
							Assessment[ij1] = dataSearch.GetValue(5).ToString();
							Requirement[ij1] = dataSearch.GetValue(2).ToString();
				...
				{
					if (Section[i1] == "5" && (VendorTesterAll[i1] == "AS" || (VendorTesterAll[i1] == "TE")))
					{
						text1[ij2] = text[i1];
						ij2++;
					}
				...
				for (int i1 = 0; i1 < Section.Length; i1++)
				{
					if (ij3[i1] != 0 || ij4[i1] != 0 || ij5[i1] != 0 || ij6[i1] != 0 ||
						ij7[i1] != 0 || ij8[i1] != 0 || ij9[i1] != 0)
					{
		...
		private void PhysicalSecurityAS_TE_FormClosing(object sender, FormClosingEventArgs e)
		{
			int ChangeFlag = 1;
			...
			if (ChangeFlag == 1)
			{
				...
				if (result == DialogResult.Yes)
				{
					...
					{
						if (VendorTesterAll[i1] == "AS" && Section[i1] == "5")
						{
						...
						if (VendorTesterAll[i1] == "TE" && Section[i1] == "5")
						{
							string inputStr = ModAssessment[i4];
							// Check if the string contains a single quote
							if (inputStr != null)
					...
					color_PhySec = SectionProgress(ij3, ij4, ij5, ij6, ij7, ij8, ij9);
					Properties.Settings.Default.color_PhySec = color_PhySec;
		...
		public string SectionProgress(int[] ij0, int[] ij1, int[] ij2, int[] ij3, int[] ij4, int[] ij5, int[] ij6)
		{
			string color_PhySec = "True";

			for (int i11 = 0; i11 < dataGridView_ASTE.Rows.Count - 1; i11++)
			{
				if ((ij0[i11] == 0) || (ij1[i11] == 0) || (ij2[i11] == 0) || (ij3[i11] == 0) ||
					(ij4[i11] == 0) || (ij5[i11] == 0) || (ij6[i11] == 0))
				{
