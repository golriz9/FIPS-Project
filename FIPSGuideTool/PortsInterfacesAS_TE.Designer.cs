...
{
	partial class PortsInterfacesAS_TE
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PortsInterfacesAS_TE));
			...
			this.dataGridView_ASTE.TabIndex = 1;
			this.dataGridView_ASTE.CellContentClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.dataGridView_ASTE_CellContentClick_1);
			...
			this.Name = "PortsInterfacesAS_TE";
			this.Text = "Ports & Interfaces Assertions and TEs";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.PortsInterfacesAS_TE_FormClosing);
			this.Load += new System.EventHandler(this.PortsInterfacesAS_TE_Load);
